		...
		//////////////////////////////////////////////////////////////////////////////////////
			...
			// Settings
				settings: {
					...
					popupOverlayOpacity:	0.85,		// Popup overlay opacity
					...
					// Desktop only
						...
						resetScroll:		false,		// If true, reel scroll will reset on page refresh
						scrollFactor:		1,			// Scales the scroll delta (1 = normal, 2 = double, 0.5 = half, etc.)
						scrollKeyAmount:	50,			// Scroll amount when using keys
						scrollZoneAmount:	20,			// Scroll amount when using scroll zones
					...
					// Scrolling
						...
						// Scroll Wheel
							...
							else
							{
								...
								_.objects.main[0].addEventListener('DOMMouseScroll', scrollHandler, false);
								_.objects.main[0].addEventListener('mousewheel', scrollHandler, false);
							}
